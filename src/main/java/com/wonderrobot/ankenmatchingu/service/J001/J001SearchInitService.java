 ...
 */
@Service
public class J001SearchInitService {
	@Autowired
	 ...
	 */
	@Log
	public JSONWFCObject sj001SearchInit (J001Entity j001Entity) throws Exception {
		...
		if ("1".equals(mode)) {
			...
			J001JOB_DETAILEntityList = J001JOB_DETAILDao.j001SearchInitDepthZero(txt2);
