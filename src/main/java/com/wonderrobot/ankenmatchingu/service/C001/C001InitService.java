...
public class C001InitService {
	 ...
	 */
	@Log
	public JSONWFCObject sc001Init (C001Entity c001Entity) throws Exception {
		...
		if ("1".equals(mode)) {
			...
			C001COMMUNICATIONEntityList = C001COMMUNICATIONDao.c001InitDepthZero(txt2);
