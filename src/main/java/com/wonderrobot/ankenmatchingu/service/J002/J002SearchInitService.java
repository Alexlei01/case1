 ...
 */
@Service
public class J002SearchInitService {
	@Autowired
	 ...
	 */
	@Log
	public JSONWFCObject sj002SearchInit (J002Entity j002Entity) throws Exception {
		...
		if ("1".equals(mode)) {
			...
			J002JOB_MATCHEntityList = J002JOB_MATCHDao.j002SearchInitDepthZero(txt2);
