...
public class P002InitService {
	 ...
	 */
	@Log
	public JSONWFCObject sp002Init (P002Entity p002Entity) throws Exception {
		...
		if ("1".equals(mode)) {
			...
			P002PEOPLE_DETAILEntityList = P002PEOPLE_DETAILDao.p002InitDepthZero(txt2);
			p002pageInitValueSetByDB(P002PEOPLE_DETAILEntityList, jsonObj);
		}
		jsonObj.setScript("r", "F20230117224349574();");
		return jsonObj;
