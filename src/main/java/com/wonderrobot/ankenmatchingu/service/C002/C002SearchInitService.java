 ...
 */
@Service
public class C002SearchInitService {
	@Autowired
	 ...
	 */
	@Log
	public JSONWFCObject sc002SearchInit (C002Entity c002Entity) throws Exception {
		...
		if ("1".equals(mode)) {
			...
			C002COMMUNICATION_RECORDEntityList = C002COMMUNICATION_RECORDDao.c002SearchInitDepthZero(txt2);
