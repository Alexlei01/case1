 ...
 */
@Service
public class J003SearchInitService {
	@Autowired
	 ...
	 */
	@Log
	public JSONWFCObject sj003SearchInit (J003Entity j003Entity) throws Exception {
		...
		if ("1".equals(mode)) {
			...
			J003JOB_TAGEntityList = J003JOB_TAGDao.j003SearchInitDepthZero(txt2);
