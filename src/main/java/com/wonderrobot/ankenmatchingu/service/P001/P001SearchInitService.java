 ...
 */
@Service
public class P001SearchInitService {
	@Autowired
	 ...
	 */
	@Log
	public JSONWFCObject sp001SearchInit (P001Entity p001Entity) throws Exception {
		...
		if ("1".equals(mode)) {
			...
			P001PEOPLE_TAGEntityList = P001PEOPLE_TAGDao.p001SearchInitDepthZero(txt2);
