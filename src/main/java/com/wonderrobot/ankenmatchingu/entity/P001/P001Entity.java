 ...
 * 技術者タグ Entity
 */
public class P001Entity extends BaseEntity{
     ...
     * tagCode タグコード
     */
@Length(max=25,message="validate.msg_P001tagCode")
     ...
     * txt2 id
     */
@NotBlank(message = "validate.msg_P001txt2")
    @ApiModelProperty(value = "id")
    private String txt2;
    /**
     * value 値
     */
@Length(max=255,message="validate.msg_P001value")
